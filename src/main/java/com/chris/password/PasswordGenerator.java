...
public class PasswordGenerator {
    ...
    public static void main(String[] args) throws NoSuchAlgorithmException {
        ...
        if (username == null || username.length() == 0 || username.startsWith(" ") || username.length() < 3) {
        ...
        String passWord = "Password:" + " " + shuffleString(generateStrongPassword());
